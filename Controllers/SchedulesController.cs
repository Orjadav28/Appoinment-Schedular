...
namespace appointmnet_schdeular.Controllers
{
    ...
    public class SchedulesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ScheduleId,CourseId,InstructorId,TimeSlot")] Schedule schedule)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ScheduleId,CourseId,InstructorId,TimeSlot")] Schedule schedule)
        {
