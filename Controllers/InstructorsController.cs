...
namespace appointmnet_schdeular.Controllers
{
    ...
    public class InstructorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("InstructorId,Name")] Instructor instructor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InstructorId,Name")] Instructor instructor)
        {
